...
public partial class FICCI_DB_APPLICATIONSContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CustomerTypeId).HasName("PK__GST_Cust__0ECA2EDBBE4156C0");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__tbl_Conf__3214EC072EBCB0C2");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.TblConfigurationMasters)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__tbl_Confi__Categ__38996AB5");
        });

        modelBuilder.Entity<TblFicciRole>(entity =>
        {
            entity.HasKey(e => e.RoleId).HasName("PK__tbl_FICC__D80BB093C40C37F4");
